...
import { Repository } from 'typeorm'; // Se eliminó 'In' ya que no se utiliza
...
// Se eliminó la importación de 'filter' de rxjs ya que se usa el .filter nativo de los arrays

@Injectable()
export class EmployeesService {

    constructor(
        // Se agrega 'readonly' para cumplir con la regla de inmutabilidad
